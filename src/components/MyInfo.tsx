    ...
    return <div className={classes.behindPaper}>
        <Paper className={classes.paper}>
           ...
           <Paper square className={classes.paperTop2}>
               ...
               <span className={classes.fontLarge}>My Information Goes Here&nbsp;</span>
               <span className={classes.fontMedium}>(This is where my information goes)</span>
               <br/>
               <Box component="span" className={classes.fontLarge}>This is large font.&nbsp;</Box>
               <Box component="span" className={classes.fontMedium}>(This is smaller font.)</Box>
           </Paper>
        </Paper>
